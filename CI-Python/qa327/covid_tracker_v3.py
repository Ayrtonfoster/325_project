...
# file references
yolo_config = "qa327/network_files/yolov4-tiny.cfg"
yolo_names = "qa327/network_files/coco.names"
yolo_weights = "qa327/network_files/yolov4-tiny.weights"
...
class VideoCamera(object):
                ...
                if(CATEGORIES[classIDs[i]]) == "person":
                    ...
                    for j in idxs.flatten():
                        if(j != i):
                            ...
                            overlap = VideoCamera.DoBoxesIntersect(x, y, w , h, x2, y2, w2, h2)
    ...
    def get_frame(self):
        ...
        frame, people_count = VideoCamera.frame_class_drawer(output_yolo, frame)
